...
const mode = ref<SkuMode.Both | SkuMode.Cart | SkuMode.Buy>(1)
//Sku组件实例
...
<template>
  ...
  <scroll-view scroll-y class="viewport">
    ...
    <view class="goods">
      ...
      <!-- 操作面板 -->
      <view class="action">
        <view class="item arrow" @tap="popSku(SkuMode.Both)">
  ...
  <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
    ...
    <view class="buttons">
      <view class="addcart" @tap="popSku(SkuMode.Cart)"> 加入购物车 </view>
      <view class="buynow" @tap="popSku(SkuMode.Buy)"> 立即购买 </view>
    </view>
  </view>

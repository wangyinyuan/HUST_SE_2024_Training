...
const onSelectedAllChange = async () => {
  ...
  await putMemberCartSelectedAPI({ selected: _isAllSelected })
}
//跳转页面
const gotoPayment = () => {
...
<template>
  ...
  >
    ...
    <template v-if="memberStore.profile">
      ...
      <!-- 吸底工具栏 -->
      <view class="toolbar" :style="{ paddingottom: safeAreaInsets?.bottom + 'rpx' }">
        <text class="all" :class="{ checked: isAllSelected }" @tap="onSelectedAllChange">全选</text>

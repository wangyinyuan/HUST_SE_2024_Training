...
<template>
  <view class="content">
    <uni-forms :rules="rules" :model="formData" ref="formRef">
      <!-- 表单内容 -->
      <uni-forms-item class="formData-item" name="receiver">
        <text class="label">收货人</text>
        <input class="input" placeholder="请填写收货人姓名" v-model="formData.receiver" />
      </uni-forms-item>
      <uni-forms-item class="formData-item" name="contact">
        <text class="label">手机号码</text>
        <input class="input" placeholder="请填写收货人手机号码" v-model="formData.contact" />
      </uni-forms-item>
      <uni-forms-item class="formData-item" name="fullLocation">
      ...
      <uni-forms-item class="formData-item" name="address">

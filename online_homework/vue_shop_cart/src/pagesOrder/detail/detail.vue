...
//获取最新页面实例
const pageLatest = pages.at(-1) as any
//订单信息
...
onReady(() => {
  ...
  pageLatest.animate('.navbar .title', [{ color: 'transparent' }, { color: '#000' }], 1000, {
  ...
  pageLatest.animate('.navbar .back', [{ color: '#fff' }, { color: '#000' }], 1000, {
    scrollSource: '#scroller',
    timeRange: 1000,
    startScrollOffset: 0,
    endScrollOffset: 50,
